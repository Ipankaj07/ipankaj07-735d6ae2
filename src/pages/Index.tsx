  ...
  return (
    <>
      ...
      <div className={`min-h-screen bg-background ${bootComplete ? "opacity-100" : "opacity-0"} transition-opacity duration-500`}>
        ...
        {/* Fixed Side Elements */}
        <div className="hidden lg:block fixed left-8 bottom-0 z-30">
          <div className="flex flex-col items-center gap-6 after:content-[''] after:w-px after:h-24 after:bg-primary/50">
            <a
        ...
        <div className="hidden lg:block fixed right-8 bottom-0 z-30">
          <div className="flex flex-col items-center gap-6 after:content-[''] after:w-px after:h-24 after:bg-primary/50">
            <a
              ...
              className="text-muted-foreground hover:text-primary transition-all duration-300 text-xs tracking-widest"
